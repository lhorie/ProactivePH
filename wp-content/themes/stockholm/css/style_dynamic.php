...
<?php if (!empty($qode_options['first_color'])) { ?>
	...
	.q_image_with_text_over:hover .shader{
		background-color: rgba(<?php echo $bg_color[0]; ?>,<?php echo $bg_color[1]; ?>,<?php echo $bg_color[2]; ?>,0.9);
	}
...
<?php if (isset($qode_options['content_top_padding']) && $qode_options['content_top_padding'] !== '') { ?>
	...
	.content .content_inner > .full_width > .full_width_inner{
		padding-top: <?php echo $qode_options['content_top_padding']; ?>px;
	}
<?php } ?>
...
<?php if (isset($qode_options['content_top_padding_default_template']) && $qode_options['content_top_padding_default_template'] !== '') { ?>
	.content .content_inner > .container > .container_inner.default_template_holder{
		padding-top: <?php echo $qode_options['content_top_padding_default_template']; ?>px;
	}
<?php } ?>
...
<?php if (isset($qode_options['content_top_padding_mobile']) && $qode_options['content_top_padding_mobile'] !== '') { ?>
	@media only screen and (max-width: 1000px){
		...
		.content .content_inner > .full_width > .full_width_inner,
		.content .content_inner > .container > .container_inner.default_template_holder{
			padding-top: <?php echo $qode_options['content_top_padding_mobile']; ?>px !important;
		}
	}	
<?php } ?>
...
<?php if (!empty($qode_options['header_height'])) { ?>
	...
	<?php if($header_bottom_appearance == "fixed_hiding") { ?>
		.content.content_top_margin{
			margin-top: <?php echo $qode_options['header_height'] + $margin_top_add + 50 + 40; // 50 is logo height for fixed advanced header type, 40 is top and bottom margin of logo ?>px !important;
		}
	<?php } elseif($header_bottom_appearance == "fixed" && $qode_options['center_logo_image'] == "yes"){ ?>
		...
		?>
		.content.content_top_margin{
			margin-top: <?php echo $qode_options['header_height'] + $margin_top_add + $logo_height + 20; // 20 is top margin of logo ?>px !important;
		}
	<?php } else { ?>
		.content.content_top_margin{
...
<?php } else { ?>
	.content.content_top_margin{
		margin-top: <?php echo $header_height + $margin_top_add; ?>px !important;
	}
<?php } ?>

<?php if(!empty($qode_options['search_background_color']) || !empty($qode_options['search_text_color'])){ ?>
    .qode_search_form,
    .qode_search_form input,
    .qode_search_form input:focus{
    	<?php if(!empty($qode_options['search_text_color'])){ ?>color: <?php echo $qode_options['search_text_color']; ?>; <?php } ?>
        <?php if(!empty($qode_options['search_background_color'])){ ?>background-color: <?php echo $qode_options['search_background_color']; ?>; <?php } ?>
    }
<?php } ?>
...
<?php if(isset($qode_options['header_height_mobile']) && $qode_options['header_height_mobile'] !== "") { ?>
    @media only screen and (max-width: 1000px){
        .mobile_menu_button, .logo_wrapper, .side_menu_button, .shopping_cart_inner{
            height: <?php echo $qode_options['header_height_mobile']; ?>px !important;
        }
    }
<?php } ?>
...
<?php if((isset($qode_options['color_border_top_bottom_menu']) && $qode_options['color_border_top_bottom_menu'] != "")){ ?>
	header.centered_logo .main_menu_and_widget_holder{
		border-color: <?php echo $qode_options['color_border_top_bottom_menu']; ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['logo_mobile_header_height']) && !empty($qode_options['logo_mobile_header_height'])){ ?>
	@media only screen and (max-width: 1000px){
		.q_logo a{
			height: <?php echo $qode_options['logo_mobile_header_height']; ?>px !important;
		}
	}	
<?php } ?>
...
<?php if(isset($qode_options['logo_mobile_height']) && !empty($qode_options['logo_mobile_height'])){ ?>
	@media only screen and (max-width: 480px){
		.q_logo a{
			height: <?php echo $qode_options['logo_mobile_height']; ?>px !important;
		}
	}	
<?php } ?>
...
<?php if(!empty($qode_options['dropdown_top_separator_color'])){?>
    .drop_down .second,
    .drop_down .narrow .second .inner ul li ul{
        border-color: <?php echo $qode_options['dropdown_top_separator_color']; ?>;
    }
<?php } ?>
...
nav.main_menu > ul > li > a{
	...
	<?php if (!empty($qode_options['menu_texttransform'])) { ?> text-transform: <?php echo $qode_options['menu_texttransform'];  ?>;  <?php } ?>	
...
<?php if(!empty($qode_options['menu_padding_left_right'])){ ?>
	nav.main_menu > ul > li > a{
		<?php if (!empty($qode_options['menu_padding_left_right'])) { ?> padding: 0  <?php echo $qode_options['menu_padding_left_right']; ?>px; <?php } ?>
	}
<?php } ?>
...
header.dark.scrolled nav.main_menu > ul > li > a{
	...
	<?php if (!empty($qode_options['fixed_texttransform'])) { ?> text-transform: <?php echo $qode_options['fixed_texttransform'];  ?>;  <?php } ?>
	<?php if ($qode_options['fixed_letterspacing'] !== '') { ?> letter-spacing: <?php echo $qode_options['fixed_letterspacing'];  ?>px;  <?php } ?>
}
<?php } ?>
...
header.dark.sticky nav.main_menu > ul > li > a{
	...
	<?php if (!empty($qode_options['sticky_texttransform'])) { ?> text-transform: <?php echo $qode_options['sticky_texttransform'];  ?>;  <?php } ?>
	<?php if ($qode_options['sticky_letterspacing'] !== '') { ?> letter-spacing: <?php echo $qode_options['sticky_letterspacing'];  ?>px;  <?php } ?>	
}
<?php } ?>
...
<?php if (!empty($qode_options['mobile_color']) || !empty($qode_options['mobile_fontsize']) || !empty($qode_options['mobile_lineheight']) || !empty($qode_options['mobile_fontstyle']) || !empty($qode_options['mobile_fontweight']) || !empty($qode_options['mobile_texttransform']) || $qode_options['mobile_letter_spacing'] !== '' || $qode_options['mobile_google_fonts'] != "-1") { ?>
	...
	nav.mobile_menu ul li h4{
		...
		<?php if (!empty($qode_options['mobile_texttransform'])) { ?> text-transform: <?php echo $qode_options['mobile_texttransform'];  ?>;  <?php } ?>
		<?php if ($qode_options['mobile_letter_spacing'] !== ''){ ?>letter-spacing: <?php echo $qode_options['mobile_letter_spacing'];  ?>px;<?php } ?>
	}
	<?php if (!empty($qode_options['mobile_color'])) { ?>
		nav.mobile_menu ul > li.has_sub > span.mobile_arrow{
			 color: <?php echo $qode_options['mobile_color'];  ?>; 
		}
	<?php } ?>
<?php } ?>
...
<?php if (!empty($qode_options['vertical_mobile_background_color'])) { ?>
	@media only screen and (max-width: 1000px){
		.header_bottom,
		nav.mobile_menu{
			background-color: <?php echo $qode_options['vertical_mobile_background_color'];  ?> !important;
		}
	}
<?php } ?>
...
<?php if (isset($qode_options['interactive_banners_background_color']) && !empty($qode_options['interactive_banners_background_color'])) { ?>
	...
	.q_image_with_text_over .shader{
		background-color: rgba(<?php echo $shader_bg_color[0]; ?>,<?php echo $shader_bg_color[1]; ?>,<?php echo $shader_bg_color[2]; ?>,0.9);
	}
<?php } ?>
...
<?php if (isset($qode_options['interactive_banners_hover_background_color']) && !empty($qode_options['interactive_banners_hover_background_color'])) { ?>
	...
	.q_image_with_text_over:hover .shader{
		background-color: rgba(<?php echo $shader_hover_bg_color[0]; ?>,<?php echo $shader_hover_bg_color[1]; ?>,<?php echo $shader_hover_bg_color[2]; ?>,0.9);
	}
<?php } ?>
...
if(!empty($qode_options['input_focus_text_color']) || !empty($qode_options['input_focus_background_color']) || !empty($qode_options['input_focus_border_color'])) { ?>
	...
	input.wpcf7-form-control.wpcf7-quiz:focus{
		...
		<?php if (!empty($qode_options['input_focus_border_color'])) { ?>border-color: <?php echo $qode_options['input_focus_border_color'];  ?>; <?php } ?>
	}
<?php }
...
if(!empty($qode_options['input_focus_text_color'])) { ?>
	...
	textarea.wpcf7-form-control.wpcf7-textarea:focus::-webkit-input-placeholder{
		color: <?php echo $qode_options['input_focus_text_color'];  ?>;
	}
...
<?php if (!empty($qode_options['h1_color']) || !empty($qode_options['h1_fontsize']) || !empty($qode_options['h1_lineheight']) || !empty($qode_options['h1_fontstyle']) || !empty($qode_options['h1_fontweight']) || $qode_options['h1_letterspacing'] !== '' || $qode_options['h1_google_fonts'] != "-1" || !empty($qode_options['h1_texttransform'])) { ?>
	h1{
	    ...
	    <?php if ($qode_options['h1_letterspacing'] !== '') { ?>letter-spacing: <?php echo $qode_options['h1_letterspacing'];  ?>px; <?php } ?>
...
<?php if (!empty($qode_options['h2_color']) || !empty($qode_options['h2_fontsize']) || !empty($qode_options['h2_lineheight']) || !empty($qode_options['h2_fontstyle']) || !empty($qode_options['h2_fontweight']) || $qode_options['h2_letterspacing'] !== '' || $qode_options['h2_google_fonts'] != "-1" || !empty($qode_options['h2_texttransform'])) { ?>
	h2{
	    ...
	    <?php if ($qode_options['h2_letterspacing'] !== '') { ?>letter-spacing: <?php echo $qode_options['h2_letterspacing'];  ?>px; <?php } ?>
...
<?php if (!empty($qode_options['h3_color']) || !empty($qode_options['h3_fontsize']) || !empty($qode_options['h3_lineheight']) || !empty($qode_options['h3_fontstyle']) || !empty($qode_options['h3_fontweight']) || $qode_options['h3_letterspacing'] !== '' || $qode_options['h3_google_fonts'] != "-1" || !empty($qode_options['h3_texttransform'])) { ?>
	h3{
	    ...
	    <?php if ($qode_options['h3_letterspacing'] !== '') { ?>letter-spacing: <?php echo $qode_options['h3_letterspacing'];  ?>px; <?php } ?>
...
<?php if (!empty($qode_options['h4_color']) || !empty($qode_options['h4_fontsize']) || !empty($qode_options['h4_lineheight']) || !empty($qode_options['h4_fontstyle']) || !empty($qode_options['h4_fontweight']) || $qode_options['h4_letterspacing'] !== '' || $qode_options['h4_google_fonts'] != "-1" || !empty($qode_options['h4_texttransform'])) { ?>
	h4{
	    ...
	    <?php if ($qode_options['h4_letterspacing'] !== '') { ?>letter-spacing: <?php echo $qode_options['h4_letterspacing'];  ?>px; <?php } ?>
...
<?php if (!empty($qode_options['h5_color']) || !empty($qode_options['h5_fontsize']) || !empty($qode_options['h5_lineheight']) || !empty($qode_options['h5_fontstyle']) || !empty($qode_options['h5_fontweight']) || $qode_options['h5_letterspacing'] !== '' || $qode_options['h5_google_fonts'] != "-1" || !empty($qode_options['h5_texttransform'])) { ?>
	h5{
	    ...
	    <?php if ($qode_options['h5_letterspacing'] !== '') { ?>letter-spacing: <?php echo $qode_options['h5_letterspacing'];  ?>px; <?php } ?>
...
<?php if (!empty($qode_options['h6_color']) || !empty($qode_options['h6_fontsize']) || !empty($qode_options['h6_lineheight']) || !empty($qode_options['h6_fontstyle']) || !empty($qode_options['h6_fontweight']) || $qode_options['h6_letterspacing'] !== '' || $qode_options['h6_google_fonts'] != "-1" || !empty($qode_options['h6_texttransform'])) { ?>
	h6{
		...
		<?php if ($qode_options['h6_letterspacing'] !== '') { ?>letter-spacing: <?php echo $qode_options['h6_letterspacing'];  ?>px; <?php } ?>
...
<?php if (!empty($qode_options['page_title_color']) || !empty($qode_options['page_title_fontsize']) || !empty($qode_options['page_title_lineheight']) || !empty($qode_options['page_title_fontstyle']) || !empty($qode_options['page_title_fontweight']) || !empty($qode_options['page_title_texttransform']) || $qode_options['page_title_google_fonts'] != "-1" || isset($qode_options['page_title_letter_spacing']) && $qode_options['page_title_letter_spacing'] !== '') { ?>
	.title h1{
		...
		<?php if (!empty($qode_options['page_title_texttransform'])) { ?>text-transform: <?php echo $qode_options['page_title_texttransform'];  ?>; <?php } ?>
	}
<?php } ?>
...
<?php if (!empty($qode_options['page_subtitle_color']) || !empty($qode_options['page_subtitle_fontsize']) || $qode_options['page_subtitle_google_fonts'] != "-1" || !empty($qode_options['page_subtitle_lineheight']) || !empty($qode_options['page_subtitle_fontstyle']) || !empty($qode_options['page_subtitle_fontweight']) || !empty($qode_options['page_subtitle_texttransform']) || $qode_options['page_subtitle_letter_spacing'] !== '') { ?>
	...
	<?php if (!empty($qode_options['page_subtitle_texttransform'])) { ?>text-transform: <?php echo $qode_options['page_subtitle_texttransform'];  ?>; <?php } ?>
	<?php if ($qode_options['page_subtitle_letter_spacing'] !== '') { ?> letter-spacing: <?php echo $qode_options['page_subtitle_letter_spacing']; ?>px; <?php } ?>	
	}
<?php } ?>
...
<?php if (!empty($qode_options['page_breadcrumb_color']) || !empty($qode_options['page_breadcrumb_fontsize']) || $qode_options['page_breadcrumb_google_fonts'] != "-1" || !empty($qode_options['page_breadcrumb_lineheight']) || !empty($qode_options['page_breadcrumb_fontstyle']) || !empty($qode_options['page_breadcrumb_fontweight']) || !empty($qode_options['page_breadcrumb_texttransform']) || $qode_options['page_breadcrumb_letter_spacing'] !== '') { ?>
	...
	<?php if (!empty($qode_options['page_breadcrumb_texttransform'])) { ?>text-transform: <?php echo $qode_options['page_breadcrumb_texttransform'];  ?>; <?php } ?>
	<?php if ($qode_options['page_breadcrumb_letter_spacing'] !== '') { ?> letter-spacing: <?php echo $qode_options['page_breadcrumb_letter_spacing']; ?>px; <?php } ?>
    }
<?php } ?>
...
<?php if(isset($qode_options['blog_large_image_title_color']) && !empty($qode_options['blog_large_image_title_color'])){ ?>
	.blog_holder.blog_large_image article:not(.format-quote):not(.format-link) h2 a{
		color: <?php echo $qode_options['blog_large_image_title_color'];  ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['blog_large_image_title_hover_color']) && !empty($qode_options['blog_large_image_title_hover_color'])){ ?>
	.blog_holder.blog_large_image article:not(.format-quote):not(.format-link) h2 a:hover{
		color: <?php echo $qode_options['blog_large_image_title_hover_color'];  ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['blog_large_image_ql_title_color']) && !empty($qode_options['blog_large_image_ql_title_color'])){ ?>
	...
	.blog_holder.blog_large_image article.format-quote .post_text .quote_author{
		color: <?php echo $qode_options['blog_large_image_ql_title_color'];  ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['blog_large_image_ql_title_hover_color']) && !empty($qode_options['blog_large_image_ql_title_hover_color'])){ ?>
	...
	.blog_holder.blog_large_image article.format-quote .post_text .post_text_inner:hover .quote_author{
		color: <?php echo $qode_options['blog_large_image_ql_title_hover_color'];  ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['blog_masonry_title_color']) && !empty($qode_options['blog_masonry_title_color'])){ ?>
	...
	.latest_post_holder .latest_post_title a{
		color: <?php echo $qode_options['blog_masonry_title_color'];  ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['blog_masonry_title_hover_color']) && !empty($qode_options['blog_masonry_title_hover_color'])){ ?>
	...
	.latest_post_holder .latest_post_title a:hover{
		color: <?php echo $qode_options['blog_masonry_title_hover_color'];  ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['blog_masonry_ql_title_color']) && !empty($qode_options['blog_masonry_ql_title_color'])){ ?>
	...
	.blog_holder.masonry article.format-quote .post_text_inner .quote_author, 
	.blog_holder.masonry_full_width article.format-quote .post_text .post_text_inner .quote_author{
		color: <?php echo $qode_options['blog_masonry_ql_title_color'];  ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['blog_masonry_ql_title_hover_color']) && !empty($qode_options['blog_masonry_ql_title_hover_color'])){ ?>
	...
	.blog_holder.masonry_full_width article.format-quote .post_text .post_text_inner:hover .quote_author{
		color: <?php echo $qode_options['blog_masonry_ql_title_hover_color'];  ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['blog_masonry_article_overlay_color']) && !empty($qode_options['blog_masonry_article_overlay_color'])) { ?>
	...
	.latest_post_holder .boxes_image a .latest_post_overlay{
		background-color: rgba(<?php echo $bm_overlay_bg_color[0]; ?>,<?php echo $bm_overlay_bg_color[1]; ?>,<?php echo $bm_overlay_bg_color[2]; ?>,<?php echo $bm_overlay_transparency; ?>);
	}
<?php } ?>
...
<?php if(isset($qode_options['blog_single_ql_title_hover_color']) && !empty($qode_options['blog_single_ql_title_hover_color'])){ ?>
	...
	.blog_holder.blog_single article.format-quote .post_text .post_text_inner:hover .quote_author{
		color: <?php echo $qode_options['blog_single_ql_title_hover_color'];  ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['blog_list_info_color']) && !empty($qode_options['blog_list_info_color'])){ ?>
	...
	.latest_post_holder .post_info_section span, .latest_post_holder .post_info_section a, .latest_post_holder .post_info_section:before{
		color: <?php echo $qode_options['blog_list_info_color'];  ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['blog_list_info_hover_color']) && !empty($qode_options['blog_list_info_hover_color'])){ ?>
	...
	.latest_post_holder .post_info_section a:hover{
		color: <?php echo $qode_options['blog_list_info_hover_color'];  ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['blog_large_image_ql_author_hover_color']) && !empty($qode_options['blog_large_image_ql_author_hover_color'])){ ?>
	.blog_holder.blog_large_image article.format-quote .post_text .post_text_inner:hover .quote_author{
		color: <?php echo $qode_options['blog_large_image_ql_author_hover_color'];  ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['blog_masonry_author_hover_color']) && !empty($qode_options['blog_masonry_author_hover_color'])){ ?>
	...
	.blog_holder.masonry_full_width .post_author a:hover,
	.latest_post_holder .post_author a.post_author_link:hover{
		color: <?php echo $qode_options['blog_masonry_author_hover_color'];  ?>;
	}
<?php } ?>
...
<?php if(!empty($qode_options['blog_large_image_icon_color']) || !empty($qode_options['blog_large_image_icon_background_color'])){ ?>
	...
	.blog_holder article .post_social .blog_like i, 
	.blog_holder article .post_social .social_share_holder > a > i{
		<?php if(!empty($qode_options['blog_large_image_icon_color'])){ ?>color: <?php echo $qode_options['blog_large_image_icon_color']; ?> <?php } ?>;
		<?php if(!empty($qode_options['blog_large_image_icon_background_color'])){ ?>background-color: <?php echo $qode_options['blog_large_image_icon_background_color']; ?> <?php } ?>;
	}
<?php } ?>
...
<?php if(!empty($qode_options['blog_large_image_icon_hover_color']) || !empty($qode_options['blog_large_image_icon_background_hover_color'])){ ?>
	...
	.blog_holder article.format-link .post_text .post_text_inner:hover .post_social .blog_like .liked i{
		<?php if(!empty($qode_options['blog_large_image_icon_hover_color'])){ ?>color: <?php echo $qode_options['blog_large_image_icon_hover_color']; ?> <?php } ?>;
		<?php if(!empty($qode_options['blog_large_image_icon_background_hover_color'])){ ?>background-color: <?php echo $qode_options['blog_large_image_icon_background_hover_color']; ?> <?php } ?>;
	}
<?php } ?>
...
if(isset($qode_options['contact_form_section_title_font_family']) && $qode_options['contact_form_section_title_font_family'] !== '-1') {
	$contact_form_section_title_style[] = 'font-family: '.str_replace('+', ' ', $qode_options['contact_form_section_title_font_family']).', sans-serif';
}
...
if(isset($qode_options['contact_form_section_subtitle_font_family']) && $qode_options['contact_form_section_subtitle_font_family'] !== '-1') {
	$contact_form_section_subtitle_style[] = 'font-family: '.str_replace('+', ' ', $qode_options['contact_form_section_subtitle_font_family']).', sans-serif';
}
...
<?php if (!empty($qode_options['pricing_table_background_color'])) { ?>
	...
	.price_table_inner ul li.prices{
		<?php if (!empty($qode_options['pricing_table_background_color'])) { ?>	background-color: <?php echo $qode_options['pricing_table_background_color'];  ?>; <?php } ?>
	}
<?php } ?>

<?php if (!empty($qode_options['pricing_table_separator_color'])) { ?>
	.price_table_inner ul li.pricing_table_content li{
		<?php if (!empty($qode_options['pricing_table_separator_color'])) { ?>	border-color: <?php echo $qode_options['pricing_table_separator_color'];  ?>; <?php } ?>
	}
<?php } ?>

<?php if (!empty($qode_options['pricing_table_separator_thickness'])) { ?>
	.price_table_inner ul li.pricing_table_content li{
		<?php if (!empty($qode_options['pricing_table_separator_thickness'])) { ?>	border-width: <?php echo $qode_options['pricing_table_separator_thickness']; ?>px; <?php } ?>
	}
<?php } ?>
...
.separator.normal{
<?php if (!empty($qode_options['separator_thickness'])) { ?>	border-width: <?php echo $qode_options['separator_thickness'];  ?>px; <?php } ?>
...
{
	<?php if (!empty($qode_options['separator_small_thickness'])) { ?>	border-width: <?php echo $qode_options['separator_small_thickness'];  ?>px; <?php } ?>
...
<?php if(!empty($qode_options['pagination_hover_color'])) { ?>
	.pagination ul li a:hover, .pagination ul li.active span, .woocommerce-pagination ul.page-numbers li span.current, .woocommerce-pagination ul.page-numbers li a:hover, .single_links_pages > span, .single_links_pages a:hover span{
        color: <?php echo $qode_options['pagination_hover_color']; ?>;
    }
<?php } ?>
...
<?php if(!empty($qode_options['portfolio_pagination_hover_color'])) { ?>
	.portfolio_navigation a:hover{
        color: <?php echo $qode_options['portfolio_pagination_hover_color']; ?>;
    }
<?php } ?>
...
<?php if (!empty($qode_options['social_icon_color']) || !empty($qode_options['social_icon_background_color']) || !empty($qode_options['social_icon_border_color'])) { ?>
    .q_social_icon_holder .fa-stack{
		<?php if (!empty($qode_options['social_icon_color'])) { ?> color: <?php echo $qode_options['social_icon_color']; ?>; <?php } ?>
		<?php if (!empty($qode_options['social_icon_background_color'])) { ?> background-color: <?php echo $qode_options['social_icon_background_color']; ?>; <?php } ?>
		<?php if (!empty($qode_options['social_icon_border_color'])) { ?> border: 1px solid <?php echo $qode_options['social_icon_border_color']; ?>; <?php } ?>
	}
<?php } ?>
...
<?php if (!empty($qode_options['social_icon_hover_color']) || !empty($qode_options['social_icon_hover_background_color']) || !empty($qode_options['social_icon_hover_border_color'])) { ?>
    .q_social_icon_holder:hover .fa-stack{
		<?php if (!empty($qode_options['social_icon_hover_color'])) { ?> color: <?php echo $qode_options['social_icon_hover_color']; ?> !important; <?php } ?>
		<?php if (!empty($qode_options['social_icon_hover_background_color'])) { ?> background-color: <?php echo $qode_options['social_icon_hover_background_color']; ?> !important; <?php } ?>
		<?php if (!empty($qode_options['social_icon_hover_border_color'])) { ?> border: <?php echo $qode_options['social_icon_hover_border_color']; ?> !important; <?php } ?>
	}
<?php } ?>
...
<?php if(!empty($qode_options['social_color'])) { ?>
	.q_social_icon_holder.normal_social .simple_social,
	.q_social_icon_holder.normal_social.with_link .simple_social{
        color: <?php echo $qode_options['social_color']; ?>;
    }
<?php } ?>

<?php if(!empty($qode_options['social_hover_color'])) { ?>
	.q_social_icon_holder.normal_social:hover .simple_social{
        color: <?php echo $qode_options['social_hover_color']; ?> !important;
    }
<?php } ?>
...
if($q_back_to_top_hover_styles !== '') {
	...
	#back_to_top:hover > span{
		<?php echo $q_back_to_top_hover_styles; ?>
	}
	<?php
}
?>
...
if($q_navigation_hover_styles !== '') {
	...
	.portfolio_slider:hover .caroufredsel-direction-nav a:hover{
		<?php echo $q_navigation_hover_styles; ?>
	}
	<?php
}
?>
...
if($fs_navigation_hover_styles !== '') { ?>
	.full_screen_navigation_inner a:hover{
		<?php echo $fs_navigation_hover_styles; ?>
	}
<?php } ?>
...
<?php if (isset($qode_options['testimonials_navigation_color']) && !empty($qode_options['testimonials_navigation_color'])) { ?>
	.testimonials_holder .flex-control-paging li a{
		background-color: <?php echo $qode_options['testimonials_navigation_color']; ?>;
	}
<?php } ?>
...
<?php if (isset($qode_options['testimonials_navigation_active_color']) && !empty($qode_options['testimonials_navigation_active_color'])) { ?>
	...
	.testimonials_holder.light .flex-control-paging li a.flex-active{
		background-color: <?php echo $qode_options['testimonials_navigation_active_color']; ?>;
	}
<?php } ?>
...
<?php if (!empty($qode_options['counter_color']) || !empty($qode_options['counters_fontweight']) || !empty($qode_options['counters_font_size'])) { ?>
...
<?php if (!empty($qode_options['tabs_text_size']) || !empty($qode_options['tabs_fontweight']) || !empty($qode_options['tab_text_text_transform']) || (isset($qode_options['tabs_nav_font_family']) && $qode_options['tabs_nav_font_family'] != '-1') || !empty($qode_options['tab_text_color']) || !empty($qode_options['tab_background_color'])) { ?>
	...
	<?php if (!empty($qode_options['tab_text_text_transform'])) { ?>text-transform: <?php echo $qode_options['tab_text_text_transform'];  ?>; <?php } ?>	
	<?php if($qode_options['tabs_nav_font_family'] != "-1"){ ?>
		font-family: '<?php echo str_replace('+', ' ', $qode_options['tabs_nav_font_family']); ?>', sans-serif;
	<?php } ?>
	<?php if (!empty($qode_options['tab_text_color'])) { ?>color: <?php echo $qode_options['tab_text_color'];  ?>; <?php } ?>		
	<?php if (!empty($qode_options['tab_background_color'])) { ?>background-color: <?php echo $qode_options['tab_background_color'];  ?>; <?php } ?>
	}
<?php } ?>
...
<?php if ( !empty($qode_options['tab_active_text_color']) || !empty($qode_options['tab_active_background_color'])) { ?>
	.q_tabs .tabs-nav li.active a,
	.q_tabs .tabs-nav li a:hover{
		<?php if (!empty($qode_options['tab_active_text_color'])) { ?>color: <?php echo $qode_options['tab_active_text_color'];  ?>; <?php } ?>
		<?php if (!empty($qode_options['tab_active_background_color'])) { ?>background-color: <?php echo $qode_options['tab_active_background_color'];  ?>; <?php } ?>
	}
<?php } ?>

<?php if ( !empty($qode_options['tabs_content_text_size']) || !empty($qode_options['tabs_content_background_color'])) { ?>
	.q_tabs .tabs-container{
		<?php if (!empty($qode_options['tabs_content_text_size'])) { ?>font-size: <?php echo $qode_options['tabs_content_text_size'];  ?>px; <?php } ?>
		<?php if (!empty($qode_options['tabs_content_background_color'])) { ?>background-color: <?php echo $qode_options['tabs_content_background_color'];  ?>; <?php } ?>
	}
<?php } ?>
...
<?php if (!empty($qode_options['footer_top_padding']) || !empty($qode_options['footer_bottom_padding'])) { ?>
	.footer_top{
		<?php if (!empty($qode_options['footer_top_padding'])){ ?>padding-top: <?php echo $qode_options['footer_top_padding']; ?>px; <?php } ?>
		<?php if (!empty($qode_options['footer_bottom_padding'])){ ?>padding-bottom: <?php echo $qode_options['footer_bottom_padding']; ?>px; <?php } ?>
	}
<?php } ?>

<?php if (isset($qode_options['footer_columns_border_color']) && !empty($qode_options['footer_columns_border_color'])) { ?>
	footer.footer_border_columns .qode_column{
		border-color:<?php echo $qode_options['footer_columns_border_color']; ?>;
	}
<?php } ?>
...
<?php if (isset($qode_options['footer_top_link_hover_color']) && !empty($qode_options['footer_top_link_hover_color'])) { ?>
	.footer_top a:hover{
		color: <?php echo $qode_options['footer_top_link_hover_color']; ?>;
	}
<?php } ?>
...
<?php if (isset($qode_options['footer_bottom_link_hover_color']) && !empty($qode_options['footer_bottom_link_hover_color'])) { ?>
	...
	.footer_bottom ul li a:hover{
		color:<?php echo $qode_options['footer_bottom_link_hover_color'];  ?>; !important;
	}
<?php } ?>
...
<?php if (isset($qode_options['sidebar_title_background']) && !empty($qode_options['sidebar_title_background'])) { ?>
	aside.sidebar .widget h4{
		background-color:<?php echo $qode_options['sidebar_title_background'];  ?>;
	}
<?php } ?>

<?php if (isset($qode_options['sidebar_title_border_color']) && !empty($qode_options['sidebar_title_border_color'])) { ?>
	aside.sidebar .widget h4{
		border: 1px solid <?php echo $qode_options['sidebar_title_border_color'];  ?>;
	}
<?php } ?>
...
<?php if (isset($qode_options['sidebar_link_hover_color']) && !empty($qode_options['sidebar_link_hover_color'])) { ?>
	...
	aside.sidebar .widget.woocommerce ul.product-categories li a:hover{
		color:<?php echo $qode_options['sidebar_link_hover_color'];  ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['sidearea_link_hover_color']) && !empty($qode_options['sidearea_link_hover_color'])){ ?>
	.side_menu .widget a:hover, .side_menu .widget li:hover, .side_menu .widget li:hover>a{
		color: <?php echo $qode_options['sidearea_link_hover_color'];  ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['blog_ql_background_color']) && !empty($qode_options['blog_ql_background_color'])){ ?>
	...
	.blog_holder article.format-quote .post_text .post_text_inner{
		background-color: <?php echo $qode_options['blog_ql_background_color'];  ?>;
	}
	.blog_holder.masonry article.format-quote  .post_text_inner .qoute_mark,
	.blog_holder.masonry article.format-link .post_text .post_text_inner .link_mark,
	.blog_holder.masonry_full_width article.format-quote .post_text .post_text_inner .qoute_mark,
	...
	.blog_holder article.format-quote .post_text .post_text_inner .post_social .social_share_holder > a > i{
		color: <?php echo $qode_options['blog_ql_background_color'];  ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['blog_ql_hover_background_color']) && !empty($qode_options['blog_ql_hover_background_color'])){ ?>
	.blog_holder article.format-link .post_text .post_text_inner:hover, 
	.blog_holder article.format-quote .post_text .post_text_inner:hover{
		background-color: <?php echo $qode_options['blog_ql_hover_background_color'];  ?>;
	}
	.blog_holder.masonry article.format-quote  .post_text_inner:hover .qoute_mark,
	.blog_holder.masonry article.format-link .post_text .post_text_inner:hover .link_mark,
	.blog_holder.masonry_full_width article.format-quote .post_text .post_text_inner:hover .qoute_mark,
	...
	.blog_holder article.format-quote .post_text .post_text_inner:hover .post_social .blog_like i,
	.blog_holder article.format-quote .post_text .post_text_inner:hover .post_social .social_share_holder > a > i{
		color: <?php echo $qode_options['blog_ql_hover_background_color'];  ?>;
	}
<?php } ?>
...
<?php if (isset($qode_options['qs_slider_height_tablet']) && !empty($qode_options['qs_slider_height_tablet'])) { ?>
	@media only screen and (min-width: 480px) and (max-width: 768px){
		.q_slider .carousel, .qode_slider_preloader, .carousel-inner>.item{
			height: <?php echo $qode_options['qs_slider_height_tablet']; ?>px !important;
		}
	}
<?php } ?>
...
<?php if (isset($qode_options['qs_slider_height_mobile']) && !empty($qode_options['qs_slider_height_mobile'])) { ?>
	@media only screen and (max-width: 480px){
		.q_slider .carousel, .qode_slider_preloader, .carousel-inner>.item{
			height: <?php echo $qode_options['qs_slider_height_mobile']; ?>px !important;
		}
	}
<?php } ?>
...
if($qs_navigation_styles != ""){ ?>
    .carousel-control .prev_nav, .carousel-control .next_nav{ 
    	<?php echo $qs_navigation_styles; ?> 
	}
<?php }

if($qs_navigation_hover_styles != "") { ?>
    .carousel-control .prev_nav:hover, .carousel-control .next_nav:hover{ 
    	<?php echo $qs_navigation_hover_styles; ?> 
	}
<?php }

if($qs_navigation_control_styles != "") { ?>
    .carousel-indicators li{ 
    	<?php echo $qs_navigation_control_styles; ?> 
	}
<?php } ?>
...
<?php if(!empty($qode_options['vertical_area_padding']) && $qode_options['vertical_area_padding'] !== ''){ ?>
	aside.vertical_menu_area{
		padding: <?php echo $qode_options['vertical_area_padding']; ?>;
	}
<?php } ?>
...
<?php if(!empty($qode_options['vertical_area_alignment']) && $qode_options['vertical_area_alignment'] !== ''){ ?>
	...
	aside.vertical_menu_area .vertical_menu_area_widget_holder{
		text-align: <?php echo $qode_options['vertical_area_alignment']; ?>;
	}
<?php } ?>
...
<?php if (!empty($qode_options['vertical_menu_color']) || !empty($qode_options['vertical_menu_fontsize']) || !empty($qode_options['vertical_menu_lineheight']) || !empty($qode_options['vertical_menu_fontstyle']) || !empty($qode_options['vertical_menu_fontweight']) || !empty($qode_options['vertical_menu_texttransform']) || (isset($qode_options['vertical_menu_letterspacing']) && $qode_options['vertical_menu_letterspacing'] !== '') || $qode_options['vertical_menu_google_fonts'] != "-1") { ?>
	...
	<?php if (!empty($qode_options['vertical_menu_texttransform'])) { ?> text-transform: <?php echo $qode_options['vertical_menu_texttransform'];  ?>; <?php } ?>
	<?php if ($qode_options['vertical_menu_letterspacing'] !== '') { ?> letter-spacing: <?php echo $qode_options['vertical_menu_letterspacing'];  ?>px; <?php } ?>	
	}
<?php } ?>
...
<?php if(!empty($qode_options['vertical_dropdown_color']) || !empty($qode_options['vertical_dropdown_fontsize']) || !empty($qode_options['vertical_dropdown_lineheight']) || !empty($qode_options['vertical_dropdown_fontstyle']) || !empty($qode_options['vertical_dropdown_fontweight']) || !empty($qode_options['vertical_dropdown_texttransform']) || (isset($qode_options['vertical_dropdown_letterspacing']) && $qode_options['vertical_dropdown_letterspacing'] !== '') || $qode_options['vertical_dropdown_google_fonts'] != "-1"){ ?>
	...
	<?php if (!empty($qode_options['vertical_dropdown_texttransform'])) { ?> text-transform: <?php echo $qode_options['vertical_dropdown_texttransform'];  ?>; <?php } ?>
	<?php if ($qode_options['vertical_dropdown_letterspacing'] !== '') { ?> letter-spacing: <?php echo $qode_options['vertical_dropdown_letterspacing'];  ?>px; <?php } ?>		
	}
<?php } ?>
...
<?php if(!empty($qode_options['vertical_dropdown_color_thirdlvl']) || !empty($qode_options['vertical_dropdown_fontsize_thirdlvl']) || !empty($qode_options['vertical_dropdown_lineheight_thirdlvl']) || !empty($qode_options['vertical_dropdown_fontstyle_thirdlvl']) || !empty($qode_options['vertical_dropdown_fontweight_thirdlvl']) || !empty($qode_options['vertical_dropdown_texttransform_thirdlvl']) || (isset($qode_options['vertical_dropdown_letterspacing_thirdlvl']) && $qode_options['vertical_dropdown_letterspacing_thirdlvl'] !== '') || $qode_options['vertical_dropdown_google_fonts_thirdlvl'] != "-1"){ ?>
	...
	<?php if (!empty($qode_options['vertical_dropdown_texttransform_thirdlvl'])) { ?> text-transform: <?php echo $qode_options['vertical_dropdown_texttransform_thirdlvl'];  ?>; <?php } ?>
	<?php if ($qode_options['vertical_dropdown_letterspacing_thirdlvl'] !== '') { ?> letter-spacing: <?php echo $qode_options['vertical_dropdown_letterspacing_thirdlvl'];  ?>px; <?php } ?>	
	}
<?php } ?>
...
<?php if ((isset($qode_options['popup_menu_color']) && !empty($qode_options['popup_menu_color'])) ||
    ...
    <?php if (!empty($qode_options['popup_menu_texttransform'])) { ?> text-transform: <?php echo $qode_options['popup_menu_texttransform'];  ?>; <?php } ?>
    <?php if ($qode_options['popup_menu_letterspacing'] !== '') { ?> letter-spacing: <?php echo $qode_options['popup_menu_letterspacing'];  ?>px; <?php } ?>
    }
<?php } ?>
...
<?php if ((isset($qode_options['popup_menu_color_2nd']) && !empty($qode_options['popup_menu_color_2nd'])) ||
    ...
    <?php if (!empty($qode_options['popup_menu_texttransform_2nd'])) { ?> text-transform: <?php echo $qode_options['popup_menu_texttransform_2nd'];  ?>; <?php } ?>	
    <?php if ($qode_options['popup_menu_letterspacing_2nd'] !== '') { ?> letter-spacing: <?php echo $qode_options['popup_menu_letterspacing_2nd'];  ?>px; <?php } ?>
    }
<?php } ?>
...
<?php if ((isset($qode_options['popup_menu_3rd_hover_color']) && !empty($qode_options['popup_menu_3rd_hover_color'])) || (isset($qode_options['popup_menu_3rd_hover_background_color']) && !empty($qode_options['popup_menu_3rd_hover_background_color']))) { ?>
    ...
    <?php if (!empty($qode_options['popup_menu_3rd_hover_color'])) { ?>  color: <?php echo $qode_options['popup_menu_3rd_hover_color'];  ?>;<?php } ?>
    <?php if (!empty($qode_options['popup_menu_3rd_hover_background_color'])) { ?> background-color: <?php echo $qode_options['popup_menu_3rd_hover_background_color'];  ?>; <?php } ?>
    }
<?php } ?>
...
<?php if (isset($qode_options['portfolio_list_box_background_color']) && !empty($qode_options['portfolio_list_box_background_color'])) { ?>
	.projects_holder article .portfolio_description{
		background-color: <?php echo $qode_options['portfolio_list_box_background_color']; ?>;
	}
<?php } ?>
...
<?php if (isset($qode_options['portfolio_shader_color']) && !empty($qode_options['portfolio_shader_color'])) { ?>
    ...
    .projects_holder article .portfolio_shader, .projects_masonry_holder article .portfolio_shader, .portfolio_slides .portfolio_shader{
        background-color: rgba(<?php echo $shader_bg_color[0]; ?>,<?php echo $shader_bg_color[1]; ?>,<?php echo $shader_bg_color[2]; ?>,<?php echo $portfolio_shader_transparency; ?>);
    }
<?php } ?>
...
<?php if (isset($qode_options['portfolio_box_background_color']) && !empty($qode_options['portfolio_box_background_color'])) { ?>
    .portfolio_single.big-slider .portfolio_container, .portfolio_single.big-images .portfolio_container, .portfolio_single.gallery .portfolio_container{
        background-color: <?php echo $qode_options['portfolio_box_background_color']; ?>;
    }
<?php } ?>

<?php if (isset($qode_options['portfolio_box_lr_padding']) && $qode_options['portfolio_box_lr_padding'] !== '') { ?>
    .portfolio_single.big-slider .portfolio_container, .portfolio_single.big-images .portfolio_container, .portfolio_single.gallery .portfolio_container{
        padding-left: <?php echo $qode_options['portfolio_box_lr_padding']; ?>px;
        padding-right: <?php echo $qode_options['portfolio_box_lr_padding']; ?>px;
    }
<?php } ?>
...
<?php if (!empty($qode_options['portfolio_filter_margin_bottom'])) { ?>
    .filter_outer{
		margin-bottom: <?php echo $qode_options['portfolio_filter_margin_bottom']; ?>px !important;
	}
<?php } ?>
...
.filter_holder ul li.filter_title span{
	<?php echo $portfolio_filter_title_font_styles; ?>
}
<?php } ?>
...
if($portfolio_title_standard_list_font_styles !== '') {
    ...
    .projects_holder.standard article .portfolio_title, .projects_holder.standard article .portfolio_title a, .projects_holder.standard_no_space article .portfolio_title, .projects_holder.standard_no_space article .portfolio_title a{
    	<?php echo $portfolio_title_standard_list_font_styles; ?>
    }
    <?php
}
...
if($portfolio_title_standard_list_hover_styles !== '') {
    ...
    .projects_holder.standard article .portfolio_title a:hover, .projects_holder.standard_no_space article .portfolio_title a:hover{
    	<?php echo $portfolio_title_standard_list_hover_styles; ?>
    }
    <?php
}
?>
...
if($portfolio_category_standard_list_font_styles !== '') {
    ...
    <?php echo $portfolio_category_standard_list_font_styles; ?>
    }
    <?php
}
?>
...
if($portfolio_title_list_font_styles !== '') {
    ...
    .projects_holder.hover_text article .portfolio_title, .projects_masonry_holder article .portfolio_title, .portfolio_slides .portfolio_title{
    	<?php echo $portfolio_title_list_font_styles; ?>
    }
    <?php
}
?>
...
<?php if (!empty($qode_options['portfolio_list_icons_color']) || !empty($qode_options['portfolio_list_icons_background_color']) || !empty($qode_options['portfolio_list_icons_border_color']) || (isset($qode_options['portfolio_list_icons_border_radius']) && $qode_options['portfolio_list_icons_border_radius'] !== '')) { ?>
	...
	.portfolio_slides .icons_holder a{
		<?php if (!empty($qode_options['portfolio_list_icons_color'])) { ?> color: <?php echo $qode_options['portfolio_list_icons_color']; ?>; <?php } ?>
		<?php if (!empty($qode_options['portfolio_list_icons_background_color'])) { ?> background-color: <?php echo $qode_options['portfolio_list_icons_background_color']; ?>; <?php } ?>
		<?php if (!empty($qode_options['portfolio_list_icons_border_color'])) { ?> border-color: <?php echo $qode_options['portfolio_list_icons_border_color']; ?>; <?php } ?>
		<?php if(isset($qode_options['portfolio_list_icons_border_radius']) && $qode_options['portfolio_list_icons_border_radius'] !== '') { ?> border-radius: <?php echo $qode_options['portfolio_list_icons_border_radius'].'px;'; ?>; <?php } ?>
	}
<?php } ?>
...
<?php if (!empty($qode_options['portfolio_list_icons_hover_color']) || !empty($qode_options['portfolio_list_icons_background_hover_color']) || !empty($qode_options['portfolio_list_icons_border_hover_color'])) { ?>
	...
	.portfolio_slides .icons_holder a:hover{
		<?php if (!empty($qode_options['portfolio_list_icons_hover_color'])) { ?> color: <?php echo $qode_options['portfolio_list_icons_hover_color']; ?>; <?php } ?>
		<?php if (!empty($qode_options['portfolio_list_icons_background_hover_color'])) { ?> background-color: <?php echo $qode_options['portfolio_list_icons_background_hover_color']; ?>; <?php } ?>
		<?php if (!empty($qode_options['portfolio_list_icons_border_hover_color'])) { ?> border-color: <?php echo $qode_options['portfolio_list_icons_border_hover_color']; ?>; <?php } ?>
	}
<?php } ?>
...
<?php if (!empty($qode_options['woo_input_background_color']) || !empty($qode_options['woo_input_border_color']) || !empty($qode_options['woo_input_text_color'])) { ?>
	.woocommerce input[type="text"]:not(.qode_search_field):not(.qty), .woocommerce-page input[type="text"]:not(.qode_search_field):not(.qty), .woocommerce input[type="email"],.woocommerce-page input[type="email"], .woocommerce textarea,.woocommerce-page textarea, .woocommerce input[type="password"], .woocommerce-page input[type="password"], .woocommerce .chosen-container.chosen-container-single .chosen-single, .woocommerce-page .chosen-container.chosen-container-single .chosen-single, .woocommerce-checkout .chosen-container.chosen-container-single .chosen-single, .woocommerce table.cart div.coupon .input-text, .woocommerce-page table.cart div.coupon .input-text, .woocommerce div.cart-collaterals .select2-container .select2-choice, .woocommerce-page div.cart-collaterals .select2-container .select2-choice, .woocommerce div.product .summary table.variations td.value select, .woocommerce-checkout .select2-container .select2-choice, .woocommerce-account .select2-container .select2-choice{
		<?php if (!empty($qode_options['woo_input_background_color'])) { ?>background-color: <?php echo $qode_options['woo_input_background_color'];  ?>; <?php } ?>
		<?php if (!empty($qode_options['woo_input_border_color'])) { ?>border-color: <?php echo $qode_options['woo_input_border_color'];  ?>; <?php } ?>
		<?php if (!empty($qode_options['woo_input_text_color'])) { ?>color:<?php echo $qode_options['woo_input_text_color'];  ?>; <?php } ?>
	}
<?php } ?>
...
<?php if(!empty($qode_options['woo_input_border_width'])) { ?>
	.woocommerce input[type="text"]:not(.qode_search_field):not(.qty), .woocommerce-page input[type="text"]:not(.qode_search_field):not(.qty), .woocommerce input[type="email"], .woocommerce-page input[type="email"], .woocommerce textarea, .woocommerce-page textarea, .woocommerce input[type="password"], .woocommerce-page input[type="password"], .woocommerce table.cart div.coupon .input-text, .woocommerce-page table.cart div.coupon .input-text, .select2-container .select2-choice, .woocommerce .chosen-container.chosen-container-single .chosen-single, .woocommerce-page .chosen-container.chosen-container-single .chosen-single, .woocommerce-checkout .chosen-container.chosen-container-single .chosen-single, .woocommerce select#pa_color, .woocommerce div.product .summary table.variations td.value select{
		border-width: <?php echo $qode_options['woo_input_border_width']; ?>px;
	}
<?php } ?>
...
<?php if(!empty($qode_options['woo_input_text_color'])) { ?>
	...
	.woocommerce-page table.cart div.coupon .input-text::-webkit-input-placeholder{
		color: <?php echo $qode_options['woo_input_text_color']; ?>;
	}
...
<?php if(!empty($qode_options['woo_input_focus_text_color']) || !empty($qode_options['woo_input_focus_background_color']) || !empty($qode_options['woo_input_focus_border_color'])) { ?>
	...
	.woocommerce table.cart div.coupon .input-text:focus,.woocommerce-page table.cart div.coupon .input-text:focus{
		<?php if (!empty($qode_options['woo_input_focus_text_color'])) { ?>color: <?php echo $qode_options['woo_input_focus_text_color'];  ?>; <?php } ?>
		<?php if (!empty($qode_options['woo_input_focus_background_color'])) { ?>background-color: <?php echo $qode_options['woo_input_focus_background_color'];  ?>; <?php } ?>
		<?php if (!empty($qode_options['woo_input_focus_border_color'])) { ?>border-color: <?php echo $qode_options['woo_input_focus_border_color'];  ?>; <?php } ?>
	}
<?php } ?>
...
<?php if(!empty($qode_options['woo_input_focus_text_color'])) { ?>
	...
	.woocommerce-page table.cart div.coupon .input-text:focus::-webkit-input-placeholder{
		color: <?php echo $qode_options['woo_input_focus_text_color']; ?>;
	}
...
<?php if (isset($qode_options['woo_products_box_text_align']) && !empty($qode_options['woo_products_box_text_align'])) { ?>
	...
	.woocommerce ul.products li.product{
		text-align: <?php echo $qode_options['woo_products_box_text_align']; ?>;
	}
<?php } ?>
...
<?php if (isset($qode_options['woo_products_box_background_color']) && !empty($qode_options['woo_products_box_background_color'])) { ?>
	...
	.woocommerce ul.products li.product .product_info_box{
		background-color: <?php echo $qode_options['woo_products_box_background_color']; ?>;
	}
<?php } ?>
...
<?php if (isset($qode_options['woo_products_box_border_color']) && !empty($qode_options['woo_products_box_border_color'])) { ?>
	...
	.woocommerce .product .images a{
		border: 1px solid <?php echo $qode_options['woo_products_box_border_color']; ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['woo_products_title_hover_color']) && !empty($qode_options['woo_products_title_hover_color'])) { ?>
	...
	aside ul.product_list_widget li > a:hover{
		color: <?php echo $qode_options['woo_products_title_hover_color']; ?>;
	}
<?php } ?>
...
if(isset($qode_options['woo_products_price_old_color']) && !empty($qode_options['woo_products_price_old_color'])) { ?>
	...
	aside ul.product_list_widget li del span.amount{
		color: <?php echo $qode_options['woo_products_price_old_color']; ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['woo_products_sorting_color']) && !empty($qode_options['woo_products_sorting_color'])) { ?>
	body.archive.woocommerce-page .select2-drop{
		color: <?php echo $qode_options['woo_products_sorting_color']; ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['woo_products_sorting_dropdown_background_color']) && !empty($qode_options['woo_products_sorting_dropdown_background_color'])) { ?>
	body.archive.woocommerce-page .select2-drop{
		background-color: <?php echo $qode_options['woo_products_sorting_dropdown_background_color']; ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['woo_products_sorting_hover_color']) && !empty($qode_options['woo_products_sorting_hover_color'])) { ?>
	...
	body.archive.woocommerce-page .select2-container .select2-choice .select2-arrow:after{
		color: <?php echo $qode_options['woo_products_sorting_hover_color']; ?>;
	}
<?php } ?>
...
if(isset($qode_options['woo_products_price_filter_background_color']) && !empty($qode_options['woo_products_price_filter_background_color'])) { ?>
	.woocommerce .widget_price_filter .ui-slider-horizontal .ui-slider-range,
	.woocommerce-page .widget_price_filter .ui-slider-horizontal .ui-slider-range {
		background-color: <?php echo $qode_options['woo_products_price_filter_background_color']; ?>; 
	}
<?php } ?>
...
if(isset($qode_options['woo_products_price_filter_background_active_color']) && !empty($qode_options['woo_products_price_filter_background_active_color'])) { ?>
	...
	.woocommerce-page .widget_price_filter .price_slider_wrapper .ui-widget-content {
		background-color: <?php echo $qode_options['woo_products_price_filter_background_active_color']; ?>; 
	}
<?php } ?>
...
if(isset($qode_options['woo_products_price_filter_arrows_color']) && !empty($qode_options['woo_products_price_filter_arrows_color'])) { ?>
	...
	.woocommerce-page .widget_price_filter .ui-slider .ui-slider-handle {
		background-color: <?php echo $qode_options['woo_products_price_filter_arrows_color']; ?>; 
	}
<?php } ?>
...
<?php if(isset($qode_options['woo_product_single_title_hover_color']) && !empty($qode_options['woo_product_single_title_hover_color'])) { ?>
	.woocommerce .product h2.product_title:hover{
		color: <?php echo $qode_options['woo_product_single_title_hover_color']; ?>;
	}
<?php } ?>
...
if(isset($qode_options['woo_product_single_price_old_color']) && !empty($qode_options['woo_product_single_price_old_color'])) { ?>
	...
	.woocommerce div.product .summary p.price del span.amount{
		color: <?php echo $qode_options['woo_product_single_price_old_color']; ?>;
	}
<?php } ?>
...
<?php if(isset($qode_options['gf_label_require_color']) && $qode_options['gf_label_require_color'] !== '') { ?>
	.gform_wrapper .gfield_required{
		color: <?php echo $qode_options['gf_label_require_color']; ?> !important;
	}
<?php } ?>
...
<?php if(isset($qode_options['gf_input_focus_text_color']) && !empty($qode_options['gf_input_focus_text_color'])){ ?>
	...
	.gform_wrapper textarea:focus::-webkit-input-placeholder{
		color: <?php echo $qode_options['gf_input_focus_text_color']; ?>;
	}
