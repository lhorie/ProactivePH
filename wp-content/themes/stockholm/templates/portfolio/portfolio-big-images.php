				...
				switch ($portfolio_video_type){
					case "youtube": ?>
						<?php if($lightbox_video_single_project == "yes"){ ?>
							...
							?>
							<a class="lightbox_single_portfolio" title="<?php echo $video_title; ?>" href="http://www.youtube.com/watch?feature=player_embedded&v=<?php echo $vidID; ?>" rel="prettyPhoto[single_pretty_photo]">
					...
					case "vimeo": ?>
						<?php if($lightbox_video_single_project == "yes"){ ?>
							...
							?>
							<a class="lightbox_single_portfolio" title="<?php echo $video_title; ?>" href="http://vimeo.com/<?php echo $portfolio_image['portfoliovideoid']; ?>" rel="prettyPhoto[single_pretty_photo]">
								<i class="fa fa-play"></i>
								<img width="100%" src="<?php echo $thumbnail; ?>"></img>
							</a>
						<?php } else { ?>
