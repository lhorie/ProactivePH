...
if(!function_exists('qode_font_awesome_social')) {
    ...
    function qode_font_awesome_social() {
        ...
        return apply_filters('qode_font_awesome_social', $icons);
    }
}

if(!function_exists('qode_font_awesome_social_vc')) {
    /**
     * Returns flipped array of social icons that is used for Visual Composer
     * @return array flipped array of social icons
     */
    function qode_font_awesome_social_vc() {
        return array_flip(qode_font_awesome_social());
    }
}